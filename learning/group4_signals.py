...
class EmotionalGraphSignal:
    ...
    emotional_intensity_bucket: str = "none"  # none|low|medium|high|unknown
    shift_bucket: str = "unknown"  # stable|soft_shift|sharp_shift|mixed|unknown
    continuity_bucket: str = "none"  # none|single_turn|repeated_current_session|emerging|unknown
    mixed_affect_bucket: str = "none"  # none|positive_negative_mix|uncertainty_mix|calm_with_tension|unknown
    recovery_marker_bucket: str = "none"  # none|grounding|hope|clarity|acceptance|unknown
    explicit_emotion_bucket: str = "none"  # none|fatigue|anxiety|sadness|anger|hope|calm|joy|loneliness|mixed|unknown
    support_need_bucket: str = "none"  # none|low|medium|high|safety|unknown
    ...
    def to_safe_dict(self) -> dict[str, Any]:
        return {
            ...
            "shift_bucket": str(self.shift_bucket),
            "continuity_bucket": str(self.continuity_bucket),
            "mixed_affect_bucket": str(self.mixed_affect_bucket),
            "recovery_marker_bucket": str(self.recovery_marker_bucket),
            "explicit_emotion_bucket": str(self.explicit_emotion_bucket),
            "support_need_bucket": str(self.support_need_bucket),
