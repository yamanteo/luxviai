...
class LearningContextBuilder:
    ...
    def _build_response_mode(
        ...
        *,
        ...
        return response_mode, reasons, time_meta
    ...
    def build_live_context(
        ...
        response_mode, response_mode_reason, time_ecology_meta = self._build_response_mode(
            message=message,
            micro_signals=micro_signals,
        ...
        # Group-4 Step-2: only time_ecology micro-activation is allowed.
        # emotional_graph / cultural_epistemic / reflection remain inert in live context.
        ...
        _ = g4_emotional, g4_cultural, g4_reflection
