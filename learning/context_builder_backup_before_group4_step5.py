...
class LearningContextBuilder:
    ...
    def _build_response_mode(
        ...
        *,
        ...
        return response_mode, reasons, time_meta, reflection_meta, cultural_meta
    ...
    def build_live_context(
        ...
        response_mode, response_mode_reason, time_ecology_meta, reflection_meta, cultural_epistemic_meta = self._build_response_mode(
            message=message,
            micro_signals=micro_signals,
        ...
        # Group-4 Step-4: time_ecology, reflection, and cultural_epistemic are active.
        # emotional_graph remains inert in live context.
