...
class LearningContextBuilder:
    ...
    def _build_response_mode(
        ...
        *,
        ...
        return response_mode, reasons, time_meta, reflection_meta
    ...
    def build_live_context(
        ...
        response_mode, response_mode_reason, time_ecology_meta, reflection_meta = self._build_response_mode(
            message=message,
            micro_signals=micro_signals,
        ...
        # Group-4 Step-3: only time_ecology and reflection are active in live context.
        # emotional_graph / cultural_epistemic remain inert in live context.
