...
COMPLIANCE_PROFILES: Dict[str, Dict[str, Any]] = {
    "stop_continue": {
        ...
        "compliance_category": "flow_safety",
        ...
        "required_actions": [],
        "recommended_next_action": "no compliance gaps; monitor post-merge",
        "confidence_score": 0.87,
    },
    "websocket_stream": {
        "aliases": ["websocket", "stream", "typewriter", "tab", "delta", "done"],
        "target_component": "stream_flow",
        "compliance_category": "stream_integrity",
        ...
        "compliance_violations": [
            "tab_switch_regression_not_verified",
            "typewriter_queue_ownership_not_audited",
        ],
        "compliance_exceptions": [
            "canary_deployment_can_bypass_until_regression_ready",
        ],
        ...
        "recommended_next_action": "resolve 2 compliance violations before proceeding",
        "confidence_score": 0.83,
    },
    "workspace_export": {
        "aliases": ["workspace", "export", "pdf", "word", "file", "dosya"],
        "target_component": "export_preview",
        "compliance_category": "export_safety",
        "compliance_status": "pass",
        "compliance_requirements": [
        ...
        "compliance_readiness": True,
        "required_actions": [],
        "recommended_next_action": "run export validation before merge; compliance is green",
        "confidence_score": 0.86,
    },
    "luxway_permission": {
        "aliases": ["luxway", "permission", "izin", "phone", "telefon", "mail", "calendar"],
        "target_component": "permission_flow",
        "compliance_category": "platform_privacy",
        "compliance_status": "violation",
        "compliance_requirements": [
        ...
        "compliance_exceptions": [
            "platform_bypass_permitted_if_audited",
        ],
        "compliance_risk_level": "high",
        "compliance_readiness": False,
        "required_actions": [
    ...
    "debug_intelligence": {
        "aliases": ["debug", "fault", "report", "compliance", "test"],
        "target_component": "preview_schema",
        "compliance_category": "scaffold_safety",
        "compliance_status": "pass",
        "compliance_requirements": [
        ...
        "compliance_readiness": True,
        "required_actions": [],
        "recommended_next_action": "run smoke tests before merge; compliance is green",
...
def _select_profile(
    ...
    for pid, p in COMPLIANCE_PROFILES.items():
...
def patch_compliance_status() -> Dict[str, Any]:
    return {
        "layer": "29.3",
        "name": "Patch Compliance Preview",
        "status": "patch_compliance_ready",
        "read_only": True,
        ...
        "connected_layers": [
            "29.2", "29.1", "28", "28.6", "28.5", "28.4", "28.3",
            "28.2", "28.1", "27.6", "27.5", "27.4", "27.3", "27.2",
            "27.1", "26.7", "26.6", "25.6", "25.5", "25.4",
        ],
        "safety_note": "Read-only compliance preview. No actual compliance enforcement.",
    }


def patch_compliance_registry() -> Dict[str, Any]:
        ...
        items.append(
            {
                ...
                "compliance_risk_level": p["compliance_risk_level"],
                "compliance_readiness": p["compliance_readiness"],
                "violation_count": len(p.get("compliance_violations", [])),
                "confidence_score": p["confidence_score"],
            }
        )
    return {
        "layer": "29.3",
        "name": "Patch Compliance Registry",
        "status": "patch_compliance_registry_ready",
        "read_only": True,
        "strict_read_only": True,
        "analysis_only": True,
        "compliance_count": len(items),
        "compliances": items,
        "ready_count": sum(1 for i in items if i["compliance_readiness"] is True),
        "blocked_count": sum(1 for i in items if i["compliance_readiness"] is False),
        "pending_count": sum(1 for i in items if i["compliance_readiness"] is None),
        "pass_count": sum(1 for i in items if i.get("compliance_status") == "pass"),
        "violation_count": sum(
            1 for i in items if i.get("compliance_status") == "violation"
        ),
        "safety_flags": {
            "file_write": False,
            "memory_write": False,
...
def build_patch_compliance_preview(
    ...
    return {
        ...
        "compliance_category": p["compliance_category"],
        "compliance_status": p["compliance_status"],
        "compliance_requirements": list(p["compliance_requirements"]),
        "compliance_violations": list(p["compliance_violations"]),
        "compliance_exceptions": list(p["compliance_exceptions"]),
        "compliance_risk_level": p["compliance_risk_level"],
        "compliance_readiness": p["compliance_readiness"],
